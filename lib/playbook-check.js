...
function problemsOf (page) {
  ...
  if (a['page-time'] && !/^(\d+(–\d+)? (min|h)|\d+ h (15|30|45) min)$/.test(a['page-time'])) {
    problems.push(`:page-time: is "${a['page-time']}"; write a measured time such as "5 min", "3–4 min", "2 h" or "9 h 30 min"`)
  }
