...
* xref:lifecycle/index.adoc[Thinkube Models]: parameters, quantization and context, the numbers that decide what fits.
...
* xref:playbooks/load-a-model-on-the-node-and-context-you-choose.adoc[Load a model on the node and context you choose]: choose the node, the backend and the context length for each load.
* xref:playbooks/build-a-notebook-environment.adoc[Build a notebook environment]: the environments and how to build your own.
