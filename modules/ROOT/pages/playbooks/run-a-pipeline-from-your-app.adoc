...
* An app from the web app template. xref:webapp-template:build-a-web-app.adoc[Build a web app from the template] makes one.
...
* xref:webapp-template:change-your-app.adoc[Change your app and ship it]: build the pipeline into the app's backend.
