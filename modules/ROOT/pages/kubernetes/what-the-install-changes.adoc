...
| Control plane
| At least 4 CPU cores and 8 GB of memory to be chosen at all; exactly one. The Kubernetes install itself stops unless the machine is Ubuntu 24.04 with at least 16 vCPUs and 60 GB of memory.
